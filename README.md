...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wuvavy0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wuvavy0.containers.anotherwebservice.com/
...
```
git clone git@github.com:shokijames/container-wuvavy0.git
cd container-wuvavy0
```
...
```
docker attach container-wuvavy0
```
